// Item enchantments and descriptions for cards and detail panel
(function () {
  window.CARD_NOTES = {
    "prismatic helmet": {
      type: "enchants",
    ...
    "coal ore seed": {
      type: "desc",
      lines: [
        "\u25a0 When placed on Endstone in the End Dimension spawns a random amount of Coal Ore",
      ],
    },
    "copper ore seed": {
      type: "desc",
      lines: [
        "\u25a0 When placed on Endstone in the End Dimension spawns a random amount of Copper Ore",
      ],
    },
    "diamond ore seed": {
      type: "desc",
      lines: [
        "\u25a0 When placed on Endstone in the End Dimension spawns a random amount of Diamond Ore",
      ],
    },
    "emerald ore seed": {
      type: "desc",
      lines: [
        "\u25a0 When placed on Endstone in the End Dimension spawns a random amount of Emerald Ore",
      ],
    },
    "gold ore seed": {
      type: "desc",
      lines: [
        "\u25a0 When placed on Endstone in the End Dimension spawns a random amount of Gold Ore",
      ],
    },
    "iron ore seed": {
      type: "desc",
      lines: [
        "\u25a0 When placed on Endstone in the End Dimension spawns a random amount of Iron Ore",
      ],
    },
    "lapis ore seed": {
      type: "desc",
      lines: [
        "\u25a0 When placed on Endstone in the End Dimension spawns a random amount of Lapis Ore",
      ],
    },
    "redstone ore seed": {
      type: "desc",
      lines: [
        "\u25a0 When placed on Endstone in the End Dimension spawns a random amount of Redstone Ore",
      ],
    },
    "mystic mushroom": {
      type: "desc",
    ...
    "arcane mushroom": {
      type: "desc",
      lines: [
        "\u25a0 When consumed, instantly grants 2500xp for the Arcane skill.",
      ],
    },
    "farming mushroom": {
      type: "desc",
      lines: [
        "\u25a0 When consumed, instantly grants 2500xp for the Farming skill.",
      ],
    },
    "fishing mushroom": {
      type: "desc",
      lines: [
        "\u25a0 When consumed, instantly grants 2500xp for the Fishing skill.",
      ],
    },
    "hunting mushroom": {
      type: "desc",
      lines: [
        "\u25a0 When consumed, instantly grants 2500xp for the Hunting skill.",
      ],
    },
    "mining mushroom": {
      type: "desc",
      lines: [
        "\u25a0 When consumed, instantly grants 2500xp for the Mining skill.",
      ],
    },
    "smelting mushroom": {
      type: "desc",
      lines: [
        "\u25a0 When consumed, instantly grants 2500xp for the Smelting skill.",
      ],
    },
    "woodcutting mushroom": {
      type: "desc",
      lines: [
        "\u25a0 When consumed, instantly grants 2500xp for the Woodcutting skill.",
      ],
    },
    "glass cutter": {
      type: "desc",
    ...
    "rename kit": {
      type: "desc",
      lines: ["\u25a0 Renames randomly generated Relic names."],
    },
    "repair oil": {
      type: "desc",
      lines: [
    ...
    "echo shard": {
      type: "desc",
      lines: ["\u25a0 Can be used to craft Tracking Oils"],
    },
    "common essence": {
      type: "desc",
      lines: [
    ...
    "rare essence": {
      type: "desc",
      lines: ["\u25a0  When consumed, grants the player a random Rare relic."],
    },
    "epic essence": {
      type: "desc",
      lines: ["\u25a0  When consumed, grants the player a random Epic relic."],
    },
    "legendary essence": {
      type: "desc",
      lines: [
    ...
    collection: {
      type: "desc",
      lines: ["\u25a0 Automatically puts items in your inventory."],
    },
    "vein miner": {
      type: "desc",
      lines: [
    ...
    treefeller: {
      type: "desc",
      lines: ["\u25a0 Cuts down whole trees. (Harvest logs while sneaking)."],
    },
    "fire react": {
      type: "desc",
      lines: ["\u25a0 Chance to light attacker on fire when you are damaged."],
    },
    "obby breaker": {
      type: "desc",
      lines: ["\u25a0 Breaks obsidian faster."],
    },
    deepfry: {
      type: "desc",
      lines: ["\u25a0 Automatically cooks fish when caught."],
    },
    "comb cutter": {
      type: "desc",
      lines: [
    ...
    "cat eyes": {
      type: "desc",
      lines: ["\u25a0 Permanently gives Night Vision while worn."],
    },
    bait: {
      type: "desc",
      lines: ["\u25a0 Chance to have double the fish drops when fishing."],
    },
    "solar lure": {
      type: "desc",
      lines: ["\u25a0 Increases the Lure effects during daytime."],
    },
    "lunar lure": {
      type: "desc",
      lines: ["\u25a0 Increases the Lure effects during nighttime."],
    },
    "potent poison": {
      type: "desc",
      lines: ["\u25a0 Chance to afflict enemy with poison."],
    },
    "mint breath": {
      type: "desc",
      lines: ["\u25a0 Grants immunity to Dragon's Breath."],
    },
    "magma walker": {
      type: "desc",
    ...
    "end veil": {
      type: "desc",
      lines: ["\u25a0 No longer aggravates endermen when looking at them."],
    },
    "sculk smite": {
      type: "desc",
      lines: ["\u25a0 Deals more damage towards the Warden."],
    },
    "dune walker": {
      type: "desc",
      lines: ["\u25a0 Walks faster when on sand."],
    },
    decapitation: {
      type: "desc",
      lines: ["\u25a0 Drops the enemy player's head upon their death."],
    },
    placeholder: {
      type: "desc",
      lines: ["\u25a0 "],
